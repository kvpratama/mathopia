...
public class PerkalianGameScene3 extends BaseScene{
...
//		int[] numbers = { 6531, 6000, 4000, 500, 700, 30, 80, 1, 7, 40 };
//		int[] numbers = { 8000, 500, 0, 3, 8503, 8530, 8035, 8053, 8305, 8350, 8583 };
		int[] numbers = { 5, 26, 130, 120, 133, 230, 220, 100, 140 };
