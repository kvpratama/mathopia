...
public class GarisBilanganGameScene5 extends BaseScene {
...
//				mystery_box.setVisible(false);
		...
		int[] numbers = {67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 66, 78};
		...
		question = new int[] { 0, 1, 5, 8 };
		indexChoicesHolder = new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
		indexChoicesNumber = new int[] { 2, 3, 4, 6, 7, 9, 10, 11, 12 };
