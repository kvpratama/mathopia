...
public class PembagianGameScene10 extends BaseScene {
...
//	private Number[] numberHolder;
	...
	private final int STAGE_ID = 50;
	private int mysteryBoxCount = 1;
	private final int REWARD_ID = 2;
...
//		numberHolder = new Number[10];
		...
		switch (random) {
		case 0:
			numbers = new int[] { 45, 5, 25, 9, 21, 30, 11, 35, 25, 10 };
			break;
		case 1:
			numbers = new int[] { 75, 4, 60, 5, 12, 20, 15, 30, 35, 10 };
			break;
		case 2:
			numbers = new int[] { 90, 5, 54, 3, 5, 7, 10, 9, 15, 12 };
			break;
		case 3:
			numbers = new int[] { 80, 4, 100, 5, 20, 15, 10, 7, 9, 11 };
			break;
		case 4:
			numbers = new int[] { 60, 5, 36, 3, 4, 30, 12, 6, 10, 9 };
			break;
...
//		}
		...
		if (random < 2) {
			...
			answerHolder[1] = this.answerHolder[6];
			answerHolder[2] = this.answerHolder[8];
		} else {
...
//		detachHolder[3] = this.answerHolder[8];
	...
	private boolean checkAnswer() {
		...
		int userAnswer = -1;
		for (int i = 0; i < swappableNumbers.length; i++) {
			if (this.answerHolder[indexUserAnswer]
					.collidesWith(swappableNumbers[i])) {
