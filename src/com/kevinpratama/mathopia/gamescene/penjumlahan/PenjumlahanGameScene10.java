...
public class PenjumlahanGameScene10 extends BaseScene {
...
//	private Number[] numberHolder;
	...
	private final int STAGE_ID = 20;
	private int mysteryBoxCount = 1;
	private final int REWARD_ID = 4;
...
//		numberHolder = new Number[9];
		...
		switch (random) {
		case 0:
			numbers = new int[] { 2368, 4823, 2455, 2544, 2554, 2454, 2545,
					3525, 2355 };
			break;
		case 1:
			numbers = new int[] { 2148, 5711, 3563, 3536, 3653, 3635, 3356,
					3365, 3566 };

			break;
		case 2:
			numbers = new int[] { 2345, 5127, 2782, 2728, 2872, 2827, 2788,
					2722, 2882 };
			break;
		case 3:
			numbers = new int[] { 2678, 4912, 2234, 2343, 2243, 2324, 2423,
					2334, 2443 };
			break;
		case 4:
			numbers = new int[] { 3354, 4138, 784, 748, 785, 775, 774, 794, 783 };
			break;
...
//		}
	...
	private boolean checkAnswer() {
		...
		// if (GameManager
		// .checkPenjumlahan(numberHolder, answerHolder, userAnswer)) {
		// false_sign.setVisible(false);
		// eagle[0].detachSelf();
		// eagle[1].detachSelf();
		// eagle[2].detachSelf();
...
//	}
	...
	private void onGameComplete(int turtleCount, boolean winLose) {
		...
		if (mysteryBoxCount == 1) {
			...
			Reward reward = new Reward(REWARD_ID,
					DatabaseHandler.REWARD_UNLOCKED);
