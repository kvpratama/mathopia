...
public class PenjumlahanGameScene3 extends BaseScene{
...
//	private Number[] numberHolder;
	...
	private final int STAGE_ID = 13;
	private int mysteryBoxCount = 0;
	private final int REWARD_ID = 0;
	private final int answer = 3687;
...
//		numberHolder = new Number[10];
		...
		int[] numbers = { 3687, 3000, 4000, 500, 600, 50, 80, 8, 7, 700 };
