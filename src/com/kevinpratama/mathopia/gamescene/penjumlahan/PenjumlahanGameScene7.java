...
public class PenjumlahanGameScene7 extends BaseScene {
...
//		int[] numbers = { 8000, 500, 0, 3, 8503, 8530, 8035, 8053, 8305, 8350, 8583 };
		int[] numbers = { 1243, 1354, 2597, 2498, 2497, 2596, 2398, 2577, 3577 };
...
//	}
	...
	private void onGameComplete(int turtleCount, boolean winLose) {
		...
		if (mysteryBoxCount == 1) {
			...
			Reward reward = new Reward(REWARD_ID, DatabaseHandler.REWARD_UNLOCKED);
