...
public class PenjumlahanGameScene2 extends BaseScene {
...
//	private Number[] numberHolder;
	...
	private final int STAGE_ID = 12;
	private int mysteryBoxCount = 0;
	private final int REWARD_ID = 0;
	private final int answer = 2654;
...
//		numberHolder = new Number[10];
		...
		int[] numbers = { 2654, 1000, 2000, 500, 600, 50, 30, 4, 8, 7 };
