...
public class PenguranganGameScene8 extends BaseScene{
...
//		numberHolder = new Number[9];
		...
		int[] numbers = { 2150, 2813, 4963, 4863, 4936, 4639, 4693, 4369, 4396 };
...
//		answerHolder[3] = this.answerHolder[7];
		...
		int userAnswer = -1;
		for (int i = 0; i < swappableNumbers.length; i++) {
			if(this.answerHolder[3].collidesWith(swappableNumbers[i])){
