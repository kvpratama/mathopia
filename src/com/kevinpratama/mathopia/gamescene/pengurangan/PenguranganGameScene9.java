...
public class PenguranganGameScene9 extends BaseScene{
...
//		numberHolder = new Number[9];
		...
		int[] numbers = { 3795, 1252, 2543, 2345, 2354, 2534, 2435, 2453, 2553 };
...
//		answerHolder[3] = this.answerHolder[7];
		...
		int userAnswer = -1;
		for (int i = 0; i < swappableNumbers.length; i++) {
			if(this.answerHolder[5].collidesWith(swappableNumbers[i])){
