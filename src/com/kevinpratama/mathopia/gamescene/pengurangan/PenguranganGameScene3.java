...
public class PenguranganGameScene3 extends BaseScene {

	private Sprite[] choicesHolder, answerHolder;
//	private Number[] numberHolder;
	SwappableNumber[] swappableNumbers;
...
//		numberHolder = new Number[9];
		...
		int[] numbers = { 1564, 456, 1108, 1180, 1106, 1107, 1008, 1801, 1188 };
...
//		answerHolder[3] = this.answerHolder[7];
		...
		if (GameManager.checkPengurangan(swappableNumbers, answerHolder, userAnswer)) {
			false_sign.setVisible(false);
			eagle[0].detachSelf();
			eagle[1].detachSelf();
			eagle[2].detachSelf();
